    ...
    <div className="bg-white shadow rounded-lg border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="font-medium text-gray-700">{dateRange}</div>
      ...
      <div className="mt-4 text-center text-sm text-gray-500">
        Blue dates indicate days you journaled • Today is highlighted with a
        blue ring
      </div>
    </div>
  );
...
function generateCenteredCalendarDays(
  centerDate: Date,
  activeDates: Date[]
): CalendarDay[] {
  ...
  for (let i = 0; i < 35; i++) {
    ...
    const isCurrentMonth =
      currentDate.getUTCMonth() === center.getUTCMonth() &&
