...
import { createReferenceTask } from './actions';

export const dynamic = 'force-dynamic';

export default async function CreateReferenceTaskPage() {
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
            ...
            <p className="text-yellow-700 mb-4">
              You need to create at least one journal before you can create
              reference tasks.
            </p>
            <Link
              href="/journals/new"
    ...
    <main className="flex min-h-screen flex-col items-center p-4 md:p-12">
      <div className="w-full max-w-4xl">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-6">Create Reference Task</h1>
          <p className="text-gray-600">
            Create a template for recurring tasks that will be automatically
            generated.
          </p>
        </div>

        <form action={createReferenceTask} className="space-y-6 max-w-2xl">
          <div>
            <label
              htmlFor="title"
          ...
          <div className="flex gap-4">
            <FormButton>Create Reference Task</FormButton>
            <Link
              href="/reference-tasks"
